...
Payment-collected mutations, document upload + e-sign, stage auto-advance, `/company/audit`, Sentry, typed schema, and dead-mock cleanup are all done. Remaining options:
